...
class Music(Dict):
    ...
    hell_backspin_scratches: Optional[List] = None
    hell_charge_notes: Optional[List] = None
    charge_notes: Optional[List] = None
    backspin_scratches: Optional[List] = None
...
with open("iidx.json",'rb') as iidx:
    obj = json.load(iidx)
